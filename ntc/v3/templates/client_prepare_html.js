/* 
// =========================================================
// cleint prepared HTML javascript file
// =========================================================
*/
var preparedHTML = {
    none:'none'
    ,node:'<label class="label wrap_checkbox" for="menu_sens_checkbox_serial_"><div class="menu_content_column"><input id="menu_sens_checkbox_serial_" type="checkbox" class="checkbox"></input> <input class="writable_label" placeholder="serial_" id="menu_sens_serial_" value="name_" onkeyup="udf_req_change_node_name(this)"></input><div></div></div></label>'
    ...
    ,charts_tab:'<label id="charts_tab_id_" class="label chart_tab" onclick="udf_show_only(\'id_\')">inner_text_</label>'
    ,chart_emt:'<div id="chart_emt_id_" class="chart chart_emt" >inner_html_</div>'
    ,chart_smt:'<div id="chart_smt_id_" class="chart chart_smt" >inner_html_<div id="i18n_search_bar" class = "label_search_bar i18n_label_search_bar">탐색 바</div></div>'
